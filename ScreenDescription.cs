...
namespace studentmanagementsystem
{
    ...
    {
        InMemoryAppEngine M = new InMemoryAppEngine();
        ...
        public void showStudentScreen()
        {
            ...
            {
                Console.WriteLine("Choose 1 or 2 or 3 or 4 or 5");
            }
        ...
        public void showAdminScreen()
        {
            ...
            {
                Console.WriteLine("Choose options :1 or 2 or 3 or 4 or 5 or 6");
            }
            catch(Exception e)
            {
        ...
        public void addStudent()
        {
            try
            {
                ...
                M.register(new Student(Id, Name, Dob));
            }
            catch (FormatException ex)
            {
        ...
        public void addcourse()
        {
            ...
            if (choice == "1")
            {
                ...
                M.introduce(new DegreeCourse(courseid, coursename, duration, fees, level, isplacementavailable));
            ...
            else if (choice == "2")
            {
                ...
                M.introduce(new DiplomaCourse(courseid, coursename, duration, fees, diplomatype));
                Console.WriteLine("Course added successfully");
            }
            else
            {
