...
namespace studentmanagementsystem
{
    ...
    class InMemoryAppEngine : AppEngine
    {
        ...
        public void introduce(Course course)
        {
            ...
            {
                string strconnection = @"Data Source=DESKTOP-8EPVO9K\SQLEXPRESS;integrated security=true;initial catalog=StudentManagementSystem";
                SqlConnection con = new SqlConnection(strconnection);
                SqlCommand cmd = new SqlCommand("Course_Detail", con);
                try
                {
                    con.Open();
